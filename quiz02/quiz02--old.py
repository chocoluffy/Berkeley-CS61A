...
def make_change(amount, coins):
    ...
    if amount==smallest:
        ...
        final+= ([smallest]+make_change(amount - smallest, remove_one(coins, smallest)))
    else:
        gap=final[-1]
        final.remove(max(final))
        final+= ([smallest] + make_change(amount + gap, remove_one(coins, smallest)))
