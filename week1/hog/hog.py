...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    else: return roll_dice(num_rolls,dice=six_sided)
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0<goal and score1<goal:
        if who%2==0:
            m=take_turn(score0, score1, dice=select_dice(score0, score1))
            score0+=m
            ...
            n=take_turn(score1, score0, dice=select_dice(score1, score0))
            score1+=m
            if is_prime(score0+score1):
                if score0>score1:
                    score0+=m
